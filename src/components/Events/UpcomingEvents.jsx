...
export const UpcomingEvents = () => {
  const services = [
    { title: "Namma Ooru Vibes", desc: "Luxurious weddings crafted to perfection.", image: "/service1.jpg" },
    { title: "Namma Ooru Vibes Elite", desc: "Premium setups for conferences and launches.", image: "/service2.jpg" },
    { title: "Namma Ooru Vibes Chitiri Special", desc: "Creative decorations and joyful celebrations.", image: "/service3.jpg" },
  ...
  return (
    <section id="services" className="px-6 pt-0 pb-4 md:pt-0 max-w-7xl mx-auto">
      ...
      >
         <p className="text-lg md:text-2xl text-gold pb-0 md:pb-3">Upcoming Events</p>
      </motion.div>
